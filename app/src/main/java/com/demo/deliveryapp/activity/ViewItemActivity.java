...
import com.demo.deliveryapp.fragment.FragmentViewItemSize;
...
public class ViewItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_kind_small1 = (TextView) findViewById(R.id.tv_kind_small1);
        tv_kind_small2 = (TextView) findViewById(R.id.tv_kind_small2);
        tv_kind_medium1 = (TextView) findViewById(R.id.tv_kind_medium1);
        tv_kind_medium2 = (TextView) findViewById(R.id.tv_kind_medium2);
        tv_kind_large1 = (TextView) findViewById(R.id.tv_kind_large1);
        tv_kind_large2 = (TextView) findViewById(R.id.tv_kind_large2);
        cl_kind_small = (ConstraintLayout) findViewById(R.id.cl_kind_small);
        cl_kind_medium = (ConstraintLayout) findViewById(R.id.cl_kind_medium);
        cl_kind_large = (ConstraintLayout) findViewById(R.id.cl_kind_large);
        //
        cl_card_4 = findViewById(R.id.cl_card_4);
        tv_kind_title_4 = findViewById(R.id.tv_kind_title_4);
        tv_kind_price_4 = findViewById(R.id.tv_kind_price_4);

        cl_card_5 = findViewById(R.id.cl_card_5);
        tv_kind_title_5 = findViewById(R.id.tv_kind_title_5);
        tv_kind_price_5 = findViewById(R.id.tv_kind_price_5);


        tv_quantity_1 = findViewById(R.id.tv_quantity_1);
        tv_quantity_2 = findViewById(R.id.tv_quantity_2);
        tv_quantity_3 = findViewById(R.id.tv_quantity_3);
        tv_quantity_4 = findViewById(R.id.tv_quantity_4);
        tv_quantity_5 = findViewById(R.id.tv_quantity_5);
        ...
        btn_add_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedData sharedData = new SharedData(getBaseContext());
...
//                showChangePrice();
        ...
        cardFooter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(activity, ViewCartActivity.class);
    ...
    private void addToCart() {
        ...
        {
            Tools.showMsg(this,"Must select a topic");
            return;
        }
        product.setQuantity(count);
        StorageHelper.addToCart(product);
        Tools.showMsg(this,"Added to cart!");
        onResume();
    }
